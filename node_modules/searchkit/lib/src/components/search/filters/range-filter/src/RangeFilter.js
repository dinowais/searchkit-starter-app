...
var RangeFilter = (function (_super) {
    ...
    RangeFilter.prototype.defineAccessor = function () {
        var _a = this.props, id = _a.id, title = _a.title, min = _a.min, max = _a.max, field = _a.field, fieldOptions = _a.fieldOptions, interval = _a.interval, showHistogram = _a.showHistogram;
    ...
    RangeFilter.prototype.renderRangeComponent = function (component) {
        ...
        return core_1.renderComponent(component, {
            min: min, max: max,
            minValue: Number(lodash_2.get(state, "min", min)),
            maxValue: Number(lodash_2.get(state, "max", max)),
...
RangeFilter.propTypes = lodash_1.defaults({
